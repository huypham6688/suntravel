    ...
    answer: (
      <div className="space-y-2">
        <p>
          ...
          lĩnh vực visa. Quý khách hoàn toàn yên tâm làm visa tại Suntravel vì:
        </p>
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            ...
            voucher dịp sinh nhật, giảm giá khi đặt dịch vụ khác như vé máy bay,
            phòng khách sạn, tour du lịch...
          </li>
        </ul>
        <p className="font-semibold text-secondary">
          Hãy gọi ngay 024 3939 3539 để được đội ngũ tư vấn hỗ trợ nhanh chóng
          nhất!
        </p>
      </div>
    ),
