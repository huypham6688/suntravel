...
const navItems = [
    ...
    megaMenu: [
      {
        ...
        items: [
          ...
          { name: "Du lịch Hạ Long", href: "/du-lich-trong-nuoc?region=Hạ Long" },
          { name: "Du lịch Hải Phòng", href: "/du-lich-trong-nuoc?region=Hải Phòng" },
          { name: "Du lịch Ba Vì", href: "/du-lich-trong-nuoc?region=Ba Vì" },
          { name: "Du lịch Cao Bằng", href: "/du-lich-trong-nuoc?region=Cao Bằng" },
          { name: "Du lịch Cô Tô", href: "/du-lich-trong-nuoc?region=Cô Tô" },
          { name: "Du lịch Hà Giang", href: "/du-lich-trong-nuoc?region=Hà Giang" },
          { name: "Du lịch Hà Nội", href: "/du-lich-trong-nuoc?region=Hà Nội" },
          { name: "Du lịch Hòa Bình", href: "/du-lich-trong-nuoc?region=Hòa Bình" },
          { name: "Du lịch Ninh Bình", href: "/du-lich-trong-nuoc?region=Ninh Bình" },
          { name: "Du lịch Sapa", href: "/du-lich-trong-nuoc?region=Sapa" },
          { name: "Du lịch Sơn La", href: "/du-lich-trong-nuoc?region=Sơn La" },
          { name: "Du lịch Yên Bái", href: "/du-lich-trong-nuoc?region=Yên Bái" },
          { name: "Du lịch Điện Biên", href: "/du-lich-trong-nuoc?region=Điện Biên" },
          { name: "Du lịch Phú Thọ", href: "/du-lich-trong-nuoc?region=Phú Thọ" },
        ],
      },
      {
        title: "DU LỊCH MIỀN TRUNG",
        items: [
          { name: "Du lịch Nha Trang", href: "/du-lich-trong-nuoc?region=Nha Trang" },
          { name: "Du lịch Quy Nhơn", href: "/du-lich-trong-nuoc?region=Quy Nhơn" },
          { name: "Du lịch Đà Nẵng", href: "/du-lich-trong-nuoc?region=Đà Nẵng" },
          ...
          { name: "Du lịch Quảng Bình", href: "/du-lich-trong-nuoc?region=Quảng Bình" },
          { name: "Du lịch Sầm Sơn", href: "/du-lich-trong-nuoc?region=Sầm Sơn" },
          { name: "Du lịch Tây Nguyên", href: "/du-lich-trong-nuoc?region=Tây Nguyên" },
        ],
      },
      {
        title: "DU LỊCH MIỀN NAM",
        items: [
          { name: "Du lịch Phú Quốc", href: "/du-lich-trong-nuoc?region=Phú Quốc" },
          { name: "Du lịch Cần Thơ", href: "/du-lich-trong-nuoc?region=Cần Thơ" },
          { name: "Du lịch Côn Đảo", href: "/du-lich-trong-nuoc?region=Côn Đảo" },
          { name: "Du lịch TP. Hồ Chí Minh", href: "/du-lich-trong-nuoc?region=TP. Hồ Chí Minh" },
        ],
      },
    ],
  },
  {
    ...
    megaMenu: [
      ...
      {
        title: "CHÂU ÂU",
        items: [{ name: "Du lịch Châu Âu", href: "/du-lich-nuoc-ngoai?region=Châu Âu" }],
      },
      {
        title: "CHÂU ÚC - MỸ",
        items: [
