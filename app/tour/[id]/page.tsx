...
const toursData: Record<string, Tour> = {
  ...
  "5": {
    ...
    maxPeople: 25,
    description:
      "Combo hai quốc gia hiện đại bậc nhất Đông Nam Á. Tham quan Marina Bay Sands, Gardens by the Bay, Universal Studios và tháp đôi Petronas.",
    highlights: [
  ...
  "6": {
    ...
    maxPeople: 30,
    description:
      "Hành trình khám phá kỳ quan thiên nhiên thế giới vịnh Hạ Long và đảo Cát Bà. Trải nghiệm du thuyền, chèo kayak và thưởng thức hải sản tươi.",
    highlights: [
