...
// Ensure the Tour interface matches what your component expects.
// If Payload returns a slightly different shape (e.g. image objects instead of strings),
// you might need a transformer function.
// Based on previous code, it seems the API returned 'tour' directly.
...
async function getTour(id: string): Promise<Tour | null> {
  try {
    ...
    // Type casting or transformation might be needed here depending on your Payload definition
    return result as unknown as Tour;
  } catch (error) {
