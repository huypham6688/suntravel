    ...
    <>
      ...
      <main>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <p className="text-primary font-semibold mb-2">Đội ngũ của chúng tôi</p>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground font-serif">Những Người Đồng Hành</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {team.map((member, index) => (
                <div key={index} className="text-center group">
                  ...
                  <h3 className="font-semibold text-lg text-foreground font-serif">{member.name}</h3>
