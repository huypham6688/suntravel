            ...
            <>
                ...
                <section className="min-h-screen bg-background flex items-center justify-center px-4">
                    <div className="text-center max-w-2xl">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 font-serif">Tour không tồn tại</h1>
                        <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-lg mx-auto">
                            Rất tiếc, tour bạn đang tìm kiếm không tồn tại hoặc đã bị gỡ bỏ.<br />
    ...
    return (
        <>
            ...
            <section className="relative h-96 md:h-[80vh] overflow-hidden">
                <Image
                    src={
                        id === "singapore-malaysia" ? "https://media.istockphoto.com/id/1939500219/photo/singapore-cityscape-at-night-twilight-drone-flight-panorama.jpg?s=612x612&w=0&k=20&c=WzBoQ0MoFPfwXVjICcjSGJHUOWlCvARaDIbhBK7hBig=" :
                            id === "nhat-ban" ? "https://media.istockphoto.com/id/1087403002/photo/the-sun-rises-over-the-city-of-tokyo-in-the-morning-japan.jpg?s=612x612&w=0&k=20&c=I-SEZxKHPxKOA3K2khwq7ekU1TOqjciW2V6GLROvc1s=" :
                                id === "chau-au" ? "https://thumbs.dreamstime.com/b/view-modern-business-district-paris-la-defense-may-old-town-eiffel-tower-may-france-41119366.jpg" :
                                    id === "han-quoc" ? "https://media.istockphoto.com/id/464629385/photo/seoul-skyline.jpg?s=612x612&w=0&k=20&c=Wo9LYxk6L9z0VORPkMxjubMcAZfWAJtRJWVfiJR8jmw=" :
                                        id === "thai-lan" ? "https://media.istockphoto.com/id/505779722/photo/bangkok-city-view-from-above-thailand.jpg?s=612x612&w=0&k=20&c=rCvIhLpKQwr_HnRKArjTvqBLCmXNVvh4XWYAcA0vN6E=" :
                ...
                <div className="absolute bottom-0 left-0 p-8 md:p-16 text-white max-w-4xl">
                    {tour.badge && <Badge className="mb-4 text-lg px-4 py-1">{tour.badge}</Badge>}
                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    <div className="grid md:grid-cols-3 gap-12">
                        ...
                        <div className="md:col-span-2 space-y-12">
                            <div>
                                <h2 className="text-3xl font-bold mb-6 font-serif">Mô tả tour</h2>
                                <p className="text-lg text-muted-foreground leading-relaxed">{tour.description}</p>
                            </div>

                            <div>
                                <h2 className="text-3xl font-bold mb-8 font-serif">Lịch trình chi tiết</h2>
                                <ol className="space-y-6">
                                    {tour.itinerary.map((day, idx) => (
                                        <li key={idx} className="flex gap-4">
                                            <span className="font-bold text-primary text-lg">Ngày {idx + 1}</span>
                        ...
                        <div className="bg-card p-8 rounded-2xl shadow-lg h-fit">
                            <div className="mb-8">
                                <p className="text-3xl md:text-4xl font-bold text-primary">
                                    {typeof tour.price === "number" ? `Từ ${tour.price.toLocaleString("vi-VN")} VNĐ` : tour.price}/người
                                </p>
                                {tour.originalPrice && (
                    ...
                    <div className="mt-20">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="relative rounded-2xl overflow-hidden shadow-lg">
                                <Image src="https://media.cntraveller.com/photos/65e2024862f0a46aca87d298/16:9/w_1280,c_limit/Liberty%20Club%20Suite%20Living%20Area%20View%20Sunset%20%20-%20Photo%20Credit_%20The%20Ritz-Carlton%20New%20York,%20NoMad.jpg" alt="Phòng khách sạn" fill className="object-cover" />
                                <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                                    <h3 className="text-xl font-semibold">Ghế hạng thương gia sang trọng</h3>
                                </div>
                            </div>
                            <div className="relative rounded-2xl overflow-hidden shadow-lg">
                                <Image src="https://media.cntraveller.com/photos/65e2024862f0a46aca87d298/16:9/w_1280,c_limit/Liberty%20Club%20Suite%20Living%20Area%20View%20Sunset%20%20-%20Photo%20Credit_%20The%20Ritz-Carlton%20New%20York,%20NoMad.jpg" alt="Phòng khách sạn" fill className="object-cover" />
                                <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                                    <h3 className="text-xl font-semibold">Phòng khách sạn hiện đại với bàn làm việc</h3>
                                </div>
                            </div>
                            <div className="relative rounded-2xl overflow-hidden shadow-lg">
                                <Image src="https://www.luxurycarservicenyc.com/wp-content/uploads/2020/05/Luxury-Car-Service-NYC-Premium-Airport-Transfers-NYC-EWR-JFK-LGA-960-540-min.jpg" alt="Xe Mercedes" fill className="object-cover" />
                                <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                                    <h3 className="text-xl font-semibold">Xe riêng Mercedes đưa đón sân bay</h3>
                                </div>
                            </div>
                        </div>
                    </div>
