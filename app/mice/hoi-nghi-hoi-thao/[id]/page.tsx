...
> = {
  "hoi-nghi-khach-hang": {
    ...
    badge: "Hot",
    description:
      "Sự kiện tri ân và vinh danh khách hàng lớn nhất năm với không gian ballroom sang trọng, sân khấu chuyên nghiệp, chương trình được thiết kế riêng để truyền tải thông điệp doanh nghiệp một cách ấn tượng nhất.",
    highlights: [
  ...
  "kick-off-sales": {
    ...
    badge: "Mới",
    description:
      "Sự kiện khởi động năm kinh doanh mới hoặc ra mắt sản phẩm với năng lượng bùng nổ, kết hợp trình chiếu chuyên nghiệp, minigame tương tác và livestream đa nền tảng.",
    highlights: [
  ...
  "hoi-thao-chuyen-de": {
    ...
    reviews: 22,
    description:
      "Chương trình đào tạo chuyên sâu hoặc hội thảo chuyên đề với không gian yên tĩnh, setup linh hoạt, tập trung tối đa vào nội dung truyền đạt và tương tác giữa diễn giả - học viên.",
    highlights: [
        ...
        <section className="min-h-screen bg-background flex items-center justify-center px-4">
          <div className="text-center max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-lg mx-auto">
              Rất tiếc, dịch vụ hội nghị/hội thảo bạn đang tìm không tồn tại
              hoặc đã kết thúc.
              <br /> Hãy khám phá các dịch vụ khác!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg">
                <Link href="/mice/hoi-nghi-hoi-thao">
                  <Presentation className="mr-2 h-5 w-5" /> Các dịch vụ Hội nghị
                  - Hội thảo
                </Link>
              </Button>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl font-bold mb-6 ">Mô tả dịch vụ</h2>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg">
                <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                  <h3 className="text-xl font-semibold">
                    Sân khấu LED hiện đại & ánh sáng chuyên nghiệp
                  </h3>
                </div>
              </div>
              <div className="relative rounded-2xl overflow-hidden shadow-lg">
                <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                  <h3 className="text-xl font-semibold">
                    MC & nhân sự sự kiện giàu kinh nghiệm
                  </h3>
                </div>
              </div>
              <div className="relative rounded-2xl overflow-hidden shadow-lg">
