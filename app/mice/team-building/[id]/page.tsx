...
import { MapPin, Clock, Users, Star, Phone, Mail, CheckCircle, Trophy, Sparkles, HeartHandshake } from "lucide-react"
          ...
          <section className="min-h-screen bg-background flex items-center justify-center px-4">
            <div className="text-center max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-lg mx-auto">
                Rất tiếc, chương trình team building bạn đang tìm không tồn tại hoặc đã kết thúc.<br /> Hãy khám phá các chương trình khác!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg">
                  <Link href="/mice/team-building">
                    <MapPin className="mr-2 h-5 w-5" /> Các chương trình Team Building
                  </Link>
                </Button>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div className="md:col-span-2 space-y-12">
                <div>
                  <h2 className="text-3xl font-bold mb-6 font-serif">Mô tả chương trình</h2>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="relative rounded-2xl overflow-hidden shadow-lg">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                    <h3 className="text-xl font-semibold">Facilitator & MC chuyên nghiệp</h3>
                  </div>
                </div>
                <div className="relative rounded-2xl overflow-hidden shadow-lg">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                    <h3 className="text-xl font-semibold">Không gian resort cao cấp</h3>
                  </div>
                </div>
                <div className="relative rounded-2xl overflow-hidden shadow-lg">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 bg-gradient-to-t from-black/70 to-transparent w-full text-white">
                    <h3 className="text-xl font-semibold">Xe đưa đón riêng thoải mái</h3>
                  </div>
                </div>
              </div>
            </div>
